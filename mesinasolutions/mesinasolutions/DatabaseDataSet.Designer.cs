...
namespace mesinasolutions {
    ...
    public partial class DatabaseDataSet : global::System.Data.DataSet {
        ...
        public partial class TableDataTable : global::System.Data.TypedTableBase<TableRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public TableRow AddTableRow(string Full_Name, string Email, string Address, string Phone) {
...
namespace mesinasolutions.DatabaseDataSetTableAdapters {
    ...
    public partial class TableTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Table] WHERE (([Id] = @Original_Id) AND ((@IsNull_Full_Name = 1 AND [Full Name] IS NULL) OR ([Full Name] = @Original_Full_Name)) AND ((@IsNull_Email = 1 AND [Email] IS NULL) OR ([Email] = @Original_Email)) AND ((@IsNull_Address = 1 AND [Address] IS NULL) OR ([Address] = @Original_Address)) AND ((@IsNull_Phone = 1 AND [Phone] IS NULL) OR ([Phone] = @Original_Phone)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Table] ([Id], [Full Name], [Email], [Address], [Phone]) VALUES" +
                " (@Id, @Full_Name, @Email, @Address, @Phone);\r\nSELECT Id, [Full Name], Email, Ad" +
                "dress, Phone FROM [Table] WHERE (Id = @Id)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Table] SET [Id] = @Id, [Full Name] = @Full_Name, [Email] = @Email, [Address] = @Address, [Phone] = @Phone WHERE (([Id] = @Original_Id) AND ((@IsNull_Full_Name = 1 AND [Full Name] IS NULL) OR ([Full Name] = @Original_Full_Name)) AND ((@IsNull_Email = 1 AND [Email] IS NULL) OR ([Email] = @Original_Email)) AND ((@IsNull_Address = 1 AND [Address] IS NULL) OR ([Address] = @Original_Address)) AND ((@IsNull_Phone = 1 AND [Phone] IS NULL) OR ([Phone] = @Original_Phone)));
SELECT Id, [Full Name], Email, Address, Phone FROM [Table] WHERE (Id = @Id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, [Full Name], Email, Address, Phone FROM dbo.[Table]";
