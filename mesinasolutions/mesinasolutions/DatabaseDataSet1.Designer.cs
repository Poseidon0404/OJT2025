...
namespace mesinasolutions {
    ...
    public partial class DatabaseDataSet1 : global::System.Data.DataSet {
        ...
        public partial class MembersDataTable : global::System.Data.TypedTableBase<MembersRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public MembersRow AddMembersRow(string Full_Name, string Email, string Address, string Phone) {
...
namespace mesinasolutions.DatabaseDataSet1TableAdapters {
    ...
    public partial class MembersTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Members] WHERE (([Id] = @Original_Id) AND ((@IsNull_Full_Name = 1 AND [Full Name] IS NULL) OR ([Full Name] = @Original_Full_Name)) AND ((@IsNull_Email = 1 AND [Email] IS NULL) OR ([Email] = @Original_Email)) AND ((@IsNull_Address = 1 AND [Address] IS NULL) OR ([Address] = @Original_Address)) AND ((@IsNull_Phone = 1 AND [Phone] IS NULL) OR ([Phone] = @Original_Phone)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Members] ([Id], [Full Name], [Email], [Address], [Phone]) VALU" +
                "ES (@Id, @Full_Name, @Email, @Address, @Phone);\r\nSELECT Id, [Full Name], Email, " +
                "Address, Phone FROM Members WHERE (Id = @Id)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Members] SET [Id] = @Id, [Full Name] = @Full_Name, [Email] = @Email, [Address] = @Address, [Phone] = @Phone WHERE (([Id] = @Original_Id) AND ((@IsNull_Full_Name = 1 AND [Full Name] IS NULL) OR ([Full Name] = @Original_Full_Name)) AND ((@IsNull_Email = 1 AND [Email] IS NULL) OR ([Email] = @Original_Email)) AND ((@IsNull_Address = 1 AND [Address] IS NULL) OR ([Address] = @Original_Address)) AND ((@IsNull_Phone = 1 AND [Phone] IS NULL) OR ([Phone] = @Original_Phone)));
SELECT Id, [Full Name], Email, Address, Phone FROM Members WHERE (Id = @Id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, [Full Name], Email, Address, Phone FROM dbo.Members";
        ...
        public virtual int Delete(int Original_Id, string Original_Full_Name, string Original_Email, string Original_Address, string Original_Phone) {
        ...
        public virtual int Insert(int Id, string Full_Name, string Email, string Address, string Phone) {
        ...
        public virtual int Update(int Id, string Full_Name, string Email, string Address, string Phone, int Original_Id, string Original_Full_Name, string Original_Email, string Original_Address, string Original_Phone) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Full_Name, string Email, string Address, string Phone, int Original_Id, string Original_Full_Name, string Original_Email, string Original_Address, string Original_Phone) {
            return this.Update(Original_Id, Full_Name, Email, Address, Phone, Original_Id, Original_Full_Name, Original_Email, Original_Address, Original_Phone);
        }
    }
